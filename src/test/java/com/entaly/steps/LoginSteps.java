...
import com.entaly.commonutils.CommonUtils;
...
//	int vid;
	...
	public void i_send_end_point_with_invalid_BasePath_that_allows_a_user_need_to_post_invalid_api_data() throws Throwable {
...
//		System.out.println("Response Body is: " + body.asString());
	...
	public void i_send_end_point_with_valid_BasePath_that_allows_a_user_need_to_post_invalid_user_key_data() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		JSONObject json=new JSONObject();
	...
	public void i_send_end_point_with_valid_BasePath_that_allows_a_user_need_to_post_invalid_user_data() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		JSONObject json=new JSONObject();
	...
	public void i_send_end_point_with_valid_BasePath_that_allows_a_blank_user_need_to_post_blank_user_data() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		response=request.baseUri(baseuri).basePath("/auth/validateuser").post();
	}
	...
	public void i_send_end_point_with_BasePath_that_allows_a_user_need_to_post_validateuser_api_data() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		JSONObject json=new JSONObject();
		json.put("username", "kkeshavaswamy@qwinix.io");
	...
	public void i_send_end_point_with_invalid_BasePath_that_allows_a_user_need_to_post_before_user_login_invalid_api_data() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		JSONObject json=new JSONObject();
		json.put("username", "kkeshavaswamy@qwinix.io");
...
//		System.out.println("Response Body is: " + body.asString());
	...
	public void i_send_end_point_with_BasePath_that_allows_to_post_before_user_login_blank_user_data() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		JSONObject json=new JSONObject();
		json.put("password", "Password1234");
	...
	public void i_send_end_point_with_BasePath_that_allows_to_post_before_user_login_blank_password_data() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		JSONObject json=new JSONObject();
		json.put("username", "kkeshavaswamy@qwinix.io");
	...
	public void i_send_end_point_with_BasePath_that_allows_to_post_before_user_login_invalid_user_key_data() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		JSONObject json=new JSONObject();
		json.put("user", "kkeshavaswamy@qwinix.io");
	...
	public void it_launches_invalid_user_key_data_and_can_able_to_fetch_error_response(String invaliduser) throws Throwable {
		ResponseBody body = response.getBody();
		String notauser = response.jsonPath().getString("message");
		System.out.println("Actual--->"+notauser+"  Expected--->"+invaliduser);
		Assert.assertEquals(invaliduser, notauser);
	...
	public void i_send_end_point_with_BasePath_that_allows_to_post_before_user_login_invalid_user_value_data() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		JSONObject json=new JSONObject();
		json.put("username", "kkeshav@qwinix.io");
	...
	public void it_launches_invalid_user_value_data_and_can_able_to_fetch_error_response(String invaliduser) throws Throwable {
		ResponseBody body = response.getBody();
		String notauser = response.jsonPath().getString("message");
		System.out.println("Actual--->"+notauser+"  Expected--->"+invaliduser);
		Assert.assertEquals(invaliduser, notauser);
	...
	public void i_send_end_point_with_BasePath_that_allows_to_post_before_user_login_invalid_password_key_data() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		JSONObject json=new JSONObject();
		json.put("username", "kkeshavaswamy@qwinix.io");
	...
	public void it_launches_invalid_password_key_data_and_can_able_to_fetch_error_response(String badcreds) throws Throwable {
		ResponseBody body = response.getBody();
		String badcredentials = response.jsonPath().getString("message");
		System.out.println("Actual--->"+badcredentials+"  Expected--->"+badcreds);
		Assert.assertEquals(badcreds, badcredentials);
	...
	public void i_send_end_point_with_BasePath_that_allows_to_post_before_user_login_invalid_password_value_data() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		JSONObject json=new JSONObject();
		json.put("username", "kkeshavaswamy@qwinix.io");
	...
	public void it_launches_invalid_password_value_data_and_can_able_to_fetch_error_response(String badcreds) throws Throwable {
		ResponseBody body = response.getBody();
		String badcredentials = response.jsonPath().getString("message");
		System.out.println("Actual--->"+badcredentials+"  Expected--->"+badcreds);
		Assert.assertEquals(badcreds, badcredentials);
	...
	public void i_send_end_point_with_BasePath_that_allows_to_post_before_user_login_blank_body_credentials() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		response=request.baseUri(baseuri).basePath("/auth/auth").post();
	}
	...
	public void it_launches_blank_body_credentials_data_and_can_able_to_fetch_error_response(String invaliduser) throws Throwable {
		ResponseBody body = response.getBody();
		String notauser = response.jsonPath().getString("message");
		System.out.println("Actual--->"+notauser+"  Expected--->"+invaliduser);
		Assert.assertEquals(invaliduser, notauser);
	...
	public void i_send_end_point_with_BasePath_that_allows_to_post_before_user_login_with_blank_header() throws Throwable {
		RequestSpecification request=RestAssured.given();
		JSONObject json=new JSONObject();
		json.put("username", "kkeshavaswamy@qwinix.io");
		json.put("password", "Password");
	...
	public void it_launches_blank_header_data_and_can_able_to_fetch_error_response(String unsupported) throws Throwable {
		ResponseBody body = response.getBody();
		System.out.println("Actual--->"+body.asString()+"  Expected--->"+unsupported);
		Assert.assertEquals(unsupported, body.asString());
	}
	...
	public void i_send_end_point_with_BasePath_that_allows_a_user_need_to_post_before_user_login_api_data() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		JSONObject json=new JSONObject();
		json.put("username", "kkeshavaswamy@qwinix.io");
...
//		System.out.println("Response Body is: " + body.asString());
	...
	public void i_send_end_point_with_BasePath_that_allows_a_user_need_to_get_invalid_user_login_api() throws Throwable {
	...
	public void i_send_end_point_with_BasePath_that_allows_a_user_need_to_get_after_user_login_api_data() throws Throwable {
		String accessToken = Serenity.sessionVariableCalled("accessToken").toString();
		RequestSpecification request=RestAssured.given();
		request.header("Authorization", "Bearer "+accessToken);
		response=request.baseUri(baseuri).basePath("/user/currentuser").get();
...
//		System.out.println("Response Body is: " + body.asString());
	...
	public void the_task_launch_data_fetched_successfully_and_verified_with_response_error(String notfound) throws Throwable {
		ResponseBody body = response.getBody();
		System.out.println("Actual--->"+body.asString()+"  Expected--->"+notfound);
		Assert.assertEquals(notfound, body.asString());
	}
	...
	public void i_send_end_point_with_BasePath_that_allows_a_user_to_get_empty_accesstoken_credential() throws Throwable {
	...
	public void i_send_end_point_with_BasePath_that_allows_a_user_to_get_invalid_access_token_pattern() throws Throwable {
		String ID = Serenity.sessionVariableCalled("ID").toString();
		String accessToken = Serenity.sessionVariableCalled("accessToken").toString();
		RequestSpecification request=RestAssured.given();
		request.header("Authorization", "Bearer"+accessToken);
	...
	public void i_send_end_point_with_BasePath_that_allows_powerbi_to_get_invalid_individual_api_report_data() throws Throwable {
		String ID = Serenity.sessionVariableCalled("ID").toString();
	...
	public void i_send_end_point_with_BasePath_that_allows_powerbi_to_get_empty_accesstoken_credential() throws Throwable {
		String ID = Serenity.sessionVariableCalled("ID").toString();
		String VID = Serenity.sessionVariableCalled("VID").toString();
		RequestSpecification request=RestAssured.given();
	...
	public void i_send_end_point_with_BasePath_that_allows_powerbi_to_get_invalid_accesstoken_pattern() throws Throwable {
		String ID = Serenity.sessionVariableCalled("ID").toString();
		String VID = Serenity.sessionVariableCalled("VID").toString();
		String accessToken = Serenity.sessionVariableCalled("accessToken").toString();
		RequestSpecification request=RestAssured.given();
...
//		System.out.println("Response Body is: " + body.asString());
	...
	public void i_send_end_point_with_BasePath_that_allows_a_user_need_to_post_invalid_forgot_password_api_data() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		JSONObject json=new JSONObject();
	...
	public void i_send_end_point_with_BasePath_that_allows_a_user_need_to_post_blank_email_credential_api() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		JSONObject json=new JSONObject();
		json.put("resetPasswordLink", "http%3A%2F%2Fentalyapi.eastus.cloudapp.azure.com%3A4375%2Frp");
	...
	public void i_send_end_point_with_BasePath_that_allows_a_user_need_to_post_blank_reset_password_credential_api() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		JSONObject json=new JSONObject();
		json.put("email", "kkeshavaswamy@qwinix.io");
	...
	public void i_send_end_point_with_BasePath_that_allows_a_user_need_to_post_with_invalid_email_key() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		JSONObject json=new JSONObject();
	...
	public void i_send_end_point_with_BasePath_that_allows_a_user_need_to_post_with_invalid_email_value() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		JSONObject json=new JSONObject();
	...
	public void i_send_end_point_with_BasePath_that_allows_a_user_need_to_post_with_invalid_reset_password_link_key() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		JSONObject json=new JSONObject();
		json.put("email", "kkeshavaswamy@qwinix.io");
	...
	public void i_send_end_point_with_BasePath_that_allows_a_user_to_post_with_blank_header_of_forgot_password_api() throws Throwable {
		RequestSpecification request=RestAssured.given();
		JSONObject json=new JSONObject();
		json.put("email", "kkeshavaswamy@qwinix.io");
		json.put("resetPasswordLink", "http%3A%2F%2Fentalyapi.eastus.cloudapp.azure.com%3A4375%2Frp");
	...
	public void i_send_end_point_with_BasePath_that_allows_a_user_to_post_with_blank_body_of_forgot_password_api() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		response=request.baseUri(baseuri).basePath("/auth/fp").post();
	}
	...
	public void i_send_end_point_with_BasePath_that_allows_a_user_need_to_post_forgot_password_api_data() throws Throwable {
		RequestSpecification request=RestAssured.given();
		request.header("Content-Type", "application/json");
		JSONObject json=new JSONObject();
		json.put("email", "kkeshavaswamy@qwinix.io");
